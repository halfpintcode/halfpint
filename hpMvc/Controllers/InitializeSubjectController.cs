...
namespace hpMvc.Controllers
{
    ...
    public class InitializeSubjectController : Controller
    {
        ...
        public ActionResult Initialize(string studyID)
        {
            ...
            if (!DbInitializeContext.IsValidInitialize(this.Request.Params, out messages, out ssInsert))
            {
            ...
            Utility.SendStudyInitializedMail(toEmails.ToArray(), null, studyID, User.Identity.Name, siteName, Server, url);
        ...
        public FilePathResult InitializeSS(string studyID)
        {
            ...
            ssUtils.InitializeSS(this.Request.PhysicalApplicationPath, studyID, ssInsert);
        ...
        public ActionResult InitializePassword(string studyID)
        {
            ...
            dto.ReturnValue = DbUtils.IsStudyIDValid(studyID);
            if (dto.ReturnValue != 1)
            {
                dto.IsSuccessful = false;
                if (dto.ReturnValue == 0)
