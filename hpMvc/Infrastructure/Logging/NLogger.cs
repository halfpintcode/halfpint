...
namespace hpMvc.Infrastructure.Logging {
    public class NLogger : hpMvc.Infrastructure.Logging.ILogger {
        Logger _logger;
        public NLogger() {
        ...
        {
            LogError(BuildExceptionMessage(x, message));
        }
        ...
        string BuildExceptionMessage(Exception x, string message) {
            ...
            string strErrorMsg = "";
            if (message.Length > 0)
                strErrorMsg = Environment.NewLine + message;
